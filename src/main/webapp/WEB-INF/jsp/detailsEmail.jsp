...
<head>
		...
		<script>
			function editit()
			{
				location="${pageContext.request.contextPath}/mail/getAll.do";
			}
					...
					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">邮件标题：</td><td  align="left"><input type="text" value="${ mail.titile}" readonly="readonly"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">邮件内容：</td><td  align="left"><textarea  cols="50" rows="5" readonly="readonly">${mail.content}</textarea></td>
								</tr>
								<tr >
									<td align="right" width="30%">发信时间：</td><td  align="left">${mail.createTime }</td>
								</tr>
								<tr >
									<td align="right" width="30%">来自：</td><td  align="left"><input type="text" value="${ user.nickname}" readonly="readonly"/></td>
								</tr>
								<tr >
									<td align="right" width="30%">文件：</td><td  align="left"><a href="javascript:void(0)" onclick="downloads(${mail.id})">下载</a></td>
								</tr>
								<tr >
									<td align="center" colspan="2"><br/><input type="button"  value="返回" onclick="editit()" /></td>
								</tr>
								</table>
						</div>
					</div>
