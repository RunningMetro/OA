...
<head>
	...
	<body>
		...
		<form id="myForm" name="myForm" action="${pageContext.request.contextPath }/user/changeAccount.do" method="post">
		<input type="hidden" name="id" value="${sessionUser.id }"/>
		<input type="hidden" name="sex" value="${sessionUser.sex }">
		<input type="hidden" name="nickname" value="${sessionUser.nickname }">
		<input type="hidden" name="age" value="${sessionUser.age }">
		<input type="hidden" name="phone" value="${sessionUser.phone }">
		<input type="hidden" name="address" value="${sessionUser.address }">
					...
					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">用户名:</td><td align="left">	<input type="text" name="username" value="${sessionUser.username }"  id="username"/><span>*</span></td>
								</tr>
								<tr >
									<td align="right" width="30%">密码:</td><td align="left">	<input type="text" name="password" value="${sessionUser.password }"  id="password"/><span>*</span></td>
								</tr>
								<tr >
									<td align="center" colspan="2"><br/><input type="submit"  id="save" value="提交数据"  /><input type="button"  value="返回" onclick="back()" /></td>
								</tr>
								</table>
						</div>
					</div>
