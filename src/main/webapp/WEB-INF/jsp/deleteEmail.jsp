...
<head>
		...
		<script>
			...
			function details(mailId){
				location.href="${pageContext.request.contextPath}/mail/todetailsEmail2.do?mailId="+mailId;
			}
		</script>
	</head>
							...
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<c:forEach items="${allmail}" var="mail">
									<tr>
										...
										<td align="center" ><a href="${pageContext.request.contextPath }/mail/return.do?id=${mail.id}"/>还原</a>|
										<a href="${pageContext.request.contextPath }/mail/remove.do?id=${mail.id}"/>删除</a></td>
									</tr>
								</c:forEach>
								</table>
						</div>
